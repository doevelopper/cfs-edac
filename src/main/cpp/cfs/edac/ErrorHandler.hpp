...
/*
   ...
   SetErrorMode    Controls whether the system will handle the specified types of serious errors, or whether the process
      will handle them.
   ...
   SetThreadErrorMode  Controls whether the system will handle the specified types of serious errors or whether the

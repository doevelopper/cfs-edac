...
#ifndef CFS_EDAC_ERROROR_HPP
#define CFS_EDAC_ERROROR_HPP
    ...
    */
    ...
    using storage_type = typename std::conditional<isRef, wrap, T>::type;
        ...
        ErrorOr(E ErrorCode, typename std::enable_if<std::is_error_code_enum<E>::value 
            || std::is_error_condition_enum<E>::value, void *>::type = nullptr)
         : HasError(true) 
    {
    ...
    template <class OtherT>
    ErrorOr( const ErrorOr<OtherT> &Other,      typename std::enable_if<std::is_convertible<OtherT, T>::value>::type * =
          nullptr) 
    {
        copyConstruct(Other);
    }

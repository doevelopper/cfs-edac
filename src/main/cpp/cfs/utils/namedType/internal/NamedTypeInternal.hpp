...
#ifndef CFS_UTILS_NAMEDTYPE_INTERNAL_NAMEDTYPEINTERNAL_HPP
#define CFS_UTILS_NAMEDTYPE_INTERNAL_NAMEDTYPEINTERNAL_HPP

#include <utility>
#include <type_traits>

namespace cfs::utils::namedType::internal
{
    template<typename T>

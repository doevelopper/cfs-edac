...
LoggerPrivate::LoggerPrivate( const std::string & logFileProperties, std::string path )
{
...
unsigned long LoggerPrivate::periodicalCheck( ) const
{
    return (this->m_watchPeriod);
}

void LoggerPrivate::periodicalCheck ( unsigned long delay)
{
    LOG4CXX_TRACE(log4cxx::Logger::getRootLogger( ), __LOG4CXX_FUNC__);
    this->m_watchPeriod = delay;
}

void LoggerPrivate::loggerReset( )
{
    LOG4CXX_TRACE( log4cxx::Logger::getRootLogger( ), __LOG4CXX_FUNC__ );
...
std::string LoggerPrivate::getFileExtension( const std::string & s )
{
    LOG4CXX_TRACE( log4cxx::Logger::getRootLogger( ), __LOG4CXX_FUNC__ );
...
log4cxx::LoggerPtr LoggerPrivate::getLoggerByName( const char * loggerName )
{
    LOG4CXX_TRACE( log4cxx::Logger::getRootLogger( ), __LOG4CXX_FUNC__ );
...
void LoggerPrivate::loggerNames( std::vector<std::string> & names )
{
...
bool LoggerPrivate::checkLogManagerStatus ()
{
...
void LoggerPrivate::setRootDefaultLevel (const std::string &level)
{
    LOG4CXX_TRACE(log4cxx::Logger::getRootLogger( ), __LOG4CXX_FUNC__);
    log4cxx::Logger::getRootLogger()->setLevel(log4cxx::Level::toLevel(level, log4cxx::Level::getInfo()));
}

void LoggerPrivate::setLoggerLevel (const std::string &loggerId,
